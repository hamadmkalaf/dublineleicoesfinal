...
> (em 13/09 à tarde: D1, D3, D4 e D8 decididas; só D9 e D2 em aberto).
...
| R4 | Unifilas / postes Tensa (item d) | 100 unidades (200 m) | 100 | 1.303,00 | telegrama | fechado | Traçado 1e com a regra de 13/09 consome 73 (81 com reserva de 10 %): sobram 19. Nada a encomendar (C1). |
...
|---|---|---|---|---|---|---|---|
| C1 | Unifilas de reserva (10 %) | D4 = 1e (decidida 13/09) | 0: os 100 contratados cobrem os 81 com reserva | 0 | M. O'Byrne Hire | resolvido | se o Posto trocar para 1f/1g/1h, ainda sobra (79/72/63 com reserva) |
...
| C8 | Sinalização interna: painel seção → mesa | **D2 (b)** (no checkpoint ou na soleira) | 3 (um por porta) | ___ | ___ | aguarda D2 | |
| C9 | Placa alta numerada por mesa (número eleitor) | D2 (b) ou as 7 mesas sem guia do traçado 1e | 28 (ou 7 se só as mesas sem guia: MRV 5, 6, 9, 12, 15, 16, 21) | ___ | ___ | aguarda D2 | |
...
4. Fechar **D2 (b)** (checkpoint ou fitas): decide C8 e C9. Fechar **D9 (a)** (caderno)
   não muda o orçamento, muda a equipe (D7) e as instruções.
