...
| Arquivo | Medida | Qtd | Onde |
|---|---|---|---|
| `P0-consulta` | 2000 × 1000 mm | 1 | calçada da Merrion Road, antes do portão |
| `P0-tabela-mestra` | 2000 × 1000 mm | 2 | gradil da Merrion Road |
| `P1-portao` | 2000 × 1000 mm | 1 | grades do portão de eleitores |
| `P2-parede-leste` | 1800 × 1200 mm | 3 | vãos entre as saídas de emergência da lateral leste |
| `P3-entrada-ring3` | 2000 × 1000 mm | 1 | CCB do corredor de chegada do Ring 3 |
| `P4-boca-zona-A/B/C` | 2000 × 1000 mm | 1 cada | CCB antes da boca de cada zona |
| `P5-vinil-porta-A/B/C` | 1200 × 700 mm | 1 cada | por dentro do vidro da fachada sul |
| `P5-preferencial` | 2000 × 1000 mm | 1 | gradil do apron, junto à S7 |
| `P6-painel-porta-A/B/C` | 850 × 2000 mm | 1 cada | logo depois de cada entrada |
| `P6-bloco-A3`, `P6-bloco-C4` | 600 × 1600 mm | 16 no total | boca do corredor de cada grupo de mesas |
| `P7-saida` | 594 × 420 mm | 2 | sobre os vãos da S2 e da S8 |
