> **Nota da consolidação em `main` (17/09/2026).** Estas regras são as do
> desenho vigente do Hall 2 — a cadeia curada de sete passos. A árvore, porém,
> guarda também a consolidação integral do repositório antigo (simulador em
> `simulador/`, dashboard, Ring 3, sinalização v2, `docs/SESSAO_*.md`), que
> tem regras próprias, preservadas em
> [`docs/CLAUDE_origem_eleicoes2026.md`](docs/CLAUDE_origem_eleicoes2026.md).
> Onde as duas divergirem, vale este arquivo. O mapa de como as duas linhagens
> se encaixam, e o que ficou em conflito entre elas, está em
