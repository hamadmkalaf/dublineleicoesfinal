...
> `handoff_agregacao_dublin_2026.md`, `pesquisa_horarios_pico_votacao.md`), e as três
> fontes oficiais do Cartório Eleitoral contra as quais ele confere tudo
> (`data/oficiais/aptos_por_secao_dublin_2026-07-13.pdf`,
> `data/oficiais/secoes_agregadas_dublin_2026.pdf`,
> `data/oficiais/mrv_mesarios_dublin_2026-09-13.pdf`). Esses caminhos são do
> repositório de origem, não deste: **não são links quebrados a consertar**. Os
> números que eles sustentam já chegaram aqui consolidados, em `saidas/dados.json` e
> em `data/prancheta_hall2.json`.
...
- Os **28 pares** do PDF de agregações são exatamente as 28 mesas da
  ...
  TSE carregava — ver `docs/contexto_geral.md` §2.1.)
