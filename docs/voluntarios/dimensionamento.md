...
| Comparecimento esperado | **~11.400** (74% Dublin, 50% interior) | taxas de 2022, `docs/contexto_geral.md` |
...
> `docs/voluntarios/lista_postos.md` e em `mapa/voluntarios_postos.html`. As seções 5 a 11 deste documento
...
**`docs/voluntarios/lista_postos.md`**, que é a fonte única desses números e o documento que vai para
...
| **Voluntários de fluxo** | **60** | `docs/voluntarios/lista_postos.md` |
...
- Lista operacional dos postos: `docs/voluntarios/lista_postos.md`.
- Eleitorado e agregação: `saidas/dados.json`, dos CSVs oficiais do TSE.
- Comparecimento, orçamento e histórico: `docs/contexto_geral.md`.
