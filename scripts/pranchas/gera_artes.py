...
PECAS = [
    ('P0-consulta',      'P0-Consulta.dc.html',   2080,  820, 1,
     'Calçada da Merrion Road, no gradil do RDS, 20–30 m antes do portão'),
    ('P0-tabela-mestra', 'P0-Mestra.dc.html',     2080,  820, 2,
     'Gradil da Merrion Road, ao lado do ponto de consulta'),
    ('P1-portao',        'P1-Portao.dc.html',     2080,  820, 1,
     'Nas grades do portão de eleitores, uma folha de cada lado do vão'),
    ('P2-parede-leste',  'P2-ParedeLeste.dc.html', 2000, 1000, 3,
     'Vãos entre as 4 saídas de emergência da lateral leste, a 10,75 · 22,50 · 33,90 m do canto norte'),
    ('P3-entrada-ring3', 'P3-EntradaRing.dc.html', 2080,  820, 1,
     'Amarrado na CCB do corredor de chegada do Ring 3, logo depois do canto nordeste'),
    ('P4-boca-zona-A',   'P4-ZonaA.dc.html',      2080,  820, 1,
     'CCB de fechamento imediatamente antes da boca da zona A, virada para o trecho de fundo'),
    ('P4-boca-zona-B',   'P4-ZonaB.dc.html',      2080,  820, 1,
     'CCB de fechamento imediatamente antes da boca da zona B'),
    ('P4-boca-zona-C',   'P4-ZonaC.dc.html',      2080,  820, 1,
