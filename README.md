...
| [`mapa/mapa_publico.html`](mapa/mapa_publico.html) | **Onde você vota no RDS** — o mapa simplificado de apresentação, para a internet. Gerado por `scripts/mapa_publico.py`. |
| `saidas/onde_voce_vota.pptx` | O mesmo conteúdo em **quatro slides editáveis**, para a sala: capa, o caminho, o Hall 2 e as 51 seções. Tudo é forma nativa — retângulo, linha, caixa de texto —, não imagem colada. Gerado por `scripts/mapa_publico_pptx.py`. |
...
# A mesma coisa em PPTX editável (pede python-pptx)
python3 scripts/mapa_publico_pptx.py --grava
```
